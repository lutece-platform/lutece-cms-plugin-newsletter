...
public class NewsletterSectionDao implements INewsletterSectionDAO
{
    ...
    private static final String SQL_QUERY_SELECT_ALL_BY_ID_NEWSLETTER_AND_ORDER = " SELECT id_section, id_newsletter, section_type_name, title, section_order, category FROM newsletter_section WHERE id_newsletter = ? AND section_order = ? ";
    ...
    private static final String SQL_QUERY_FIND_NEXT_ORDER = " SELECT MAX(section_order) FROM newsletter_section WHERE id_newsletter = ? AND category = ? ";
    ...
    public void updateNewsletterSectionOrder( int nIdNewsletterSection, int nNewOrder, Plugin plugin )
    {
        ...
        daoUtil.setInt( 1, nIdNewsletterSection );
        daoUtil.setInt( 2, nNewOrder );
        daoUtil.executeUpdate( );
        daoUtil.free( );
    }
     ...
     */
    @Override
    public List<NewsletterSection> findByNewsletterIdAndOrder( int nIdNewsletter, int nOrder, Plugin plugin )
    {
    ...
    {
        DAOUtil daoUtil = new DAOUtil( SQL_QUERY_FIND_NEXT_ORDER, plugin );
        daoUtil.setInt( 1, nIdNewsletter );
